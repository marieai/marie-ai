...
MARIE_IMAGE="${MARIE_IMAGE:-marieai/marie:4.5rc1-cuda}"
GATEWAY_IMAGE="${GATEWAY_IMAGE:-marieai/marie-gateway:4.5rc1-cpu}"
...
Environment:
  ...
  MARIE_IMAGE        Executor image (default: marieai/marie:4.5rc1-cuda)
  GATEWAY_IMAGE      Gateway/server image (default: marieai/marie-gateway:4.5rc1-cpu)
