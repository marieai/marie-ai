...
class HelpScreen(ModalScreen):
    header_text = """
        Welcome to MarieAi! This screen contains a small subset of the online
        docs, available at https://github.com/marieai/marie-ai/tree/main/docs/docs/getting-started
    """.split()
    ...
    def on_mount(self) -> None:
        ...
        container.border_title = "MarieAi Help"
