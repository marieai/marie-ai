...
from marie.agent.skills.models import SkillSource
...
"""
    ...
    def test_refresh_discovers_new_skills(self, tmp_path: Path):
        ...
        loader = self._make_loader()
        loader.discover_workspace_skills(str(workspace))
        len(loader.registry.list_skills())
...
"""
        ...
        loader.registry.discover_skills(paths=[builtin_dir], source=SkillSource.BUILTIN)
