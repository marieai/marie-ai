...
class TestInMemoryAuditLogger:
    ...
    async def test_query_by_workflow_id(self, logger):
        ...
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-a", agent_name="a")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-b", agent_name="b")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_COMPLETED, "wf-a", agent_name="a")
        )
    ...
    async def test_query_by_agent_name(self, logger):
        ...
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-1", agent_name="planner")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-1", agent_name="executor")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_COMPLETED, "wf-1", agent_name="planner")
        )
    ...
    async def test_query_by_time_range(self, logger):
        ...
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-1", timestamp=past)
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-2", timestamp=now)
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-3", timestamp=future)
        )
    ...
    async def test_combined_filters(self, logger):
        ...
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-a", agent_name="planner")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_COMPLETED, "wf-a", agent_name="planner")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-a", agent_name="executor")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-b", agent_name="planner")
        )
...
class TestStructuredAuditLogger:
    ...
    async def test_query_functionality(self, logger):
        ...
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-1", agent_name="a")
        )
        await logger.log(
            AuditEvent(AuditEventType.AGENT_STARTED, "wf-2", agent_name="b")
        )
