...
class TestTaskInstanceRefCreation:
    ...
    def test_create_with_all_fields(self):
        ...
        assert ti.dag_id == "document_pipeline"
        assert ti.dag_run_id == "run_2024_001"
...
class TestTaskInstanceRefFromDict:
    ...
    def test_from_dict_missing_fields_uses_defaults(self):
        ...
        assert ti.dag_id == "my_dag"
        assert ti.dag_run_id == "my_dag"  # Falls back to dag_id
...
class TestTaskInstanceRefFromWorkInfo:
    ...
    def test_from_work_info_no_data(self):
        ...
        assert ti.dag_id == "dag_1"
        assert ti.dag_run_id == "dag_1"  # Falls back to dag_id when no data
        assert ti.task_id == "job_123"
        assert ti.try_number == 1
    ...
    def test_from_work_info_empty_dag_id(self):
        ...
        class MockWorkInfo:
            id = "job_123"
            dag_id = None
            data = {"dag_run_id": "explicit_run"}

        ti = TaskInstanceRef.from_work_info(MockWorkInfo())
        assert ti.dag_id == ""
        assert ti.dag_run_id == "explicit_run"
...
class TestTaskInstanceRefWithTryNumber:
    ...
    def test_with_try_number_preserves_other_fields(self):
        ...
        assert ti2.dag_id == "my_dag"
        assert ti2.dag_run_id == "run_123"
