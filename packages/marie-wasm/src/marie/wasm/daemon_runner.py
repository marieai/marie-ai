...
The plugin daemon spawns this module as `python -m marie.wasm.daemon_runner` in
...
from marie.wasm import BUILTIN_NODES_DIR, Permissions
from marie.wasm.host import DefaultHttpClient, HostImplementations
...
def load_config(working_dir: str) -> RunnerConfig:
    ...
    from marie.wasm.types import BUILTIN_PERMISSIONS
