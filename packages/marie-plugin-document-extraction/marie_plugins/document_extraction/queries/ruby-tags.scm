...
(method_parameters (identifier) @name.definition.parameter) @definition.parameter
(block_parameters (identifier) @name.definition.parameter) @definition.parameter
(assignment left: (identifier) @name.definition.variable) @definition.variable
(assignment left: (instance_variable) @name.definition.property) @definition.property
