...
(parameter name: (simple_identifier) @name.definition.parameter) @definition.parameter
(property_declaration (pattern (simple_identifier) @name.definition.variable)) @definition.variable
