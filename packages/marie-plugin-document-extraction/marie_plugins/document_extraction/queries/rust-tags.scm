...
(parameter pattern: (identifier) @name.definition.parameter) @definition.parameter
(let_declaration pattern: (identifier) @name.definition.variable) @definition.variable
