...
Application Services:
NAME                 IMAGE                             COMMAND                  SERVICE                  CREATED        STATUS                                     PORTS
marieai-dev-server   marieai/marie:5.0.3-cuda          "marie server --star…"   marie-extract-executor   1 second ago   Up Less than a second
marieai-gateway      marieai/marie-gateway:5.0.3-cpu   "marie gateway --use…"   marie-gateway            1 second ago   Up Less than a second (health: starting)
...
7c999f7e4b00   marieai/marie:5.0.3-cuda                          "marie server --star…"   About a minute ago   Up About a minute                       marieai-dev-server
31acc1cc4ec0   marieai/marie-gateway:5.0.3-cpu                   "marie gateway --use…"   About a minute ago   Up About a minute (healthy)             marieai-gateway
