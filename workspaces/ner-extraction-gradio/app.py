...
# executor = NerExtractionExecutor("/mnt/data/models/layoutlmv3-base-stride/checkpoint-4000")
# executor = NerExtractionExecutor("/mnt/data/models/layoutlmv3-base-stride-ASPGPU/checkpoint-24648")
# executor = NerExtractionExecutor("/mnt/data/models/layoutlmv3-base-stride/checkpoint-2000")
# executor = NerExtractionExecutor("/mnt/data/models/layoutlmv3-base-finetuned/checkpoint-3000") # Finetuned on 2021-09-30
