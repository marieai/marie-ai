...
# This script builds the Marie AI Docker image with profile support.
set -e
...
show_help() {
    ...
    echo "  $0 --version 5.0.2 marie-cuda        # Build CUDA image with version 5.0.2"
    echo "  $0 -v 5.0.2 all                      # Build all images with version 5.0.2"
    echo "  MARIE_VERSION=5.0.2 $0 marie-cuda    # Using environment variable"
}
