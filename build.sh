...
show_help() {
    ...
    echo "  $0 --version 5.0.1 marie-cuda        # Build CUDA image with version 5.0.1"
    echo "  $0 -v 5.0.1 all                      # Build all images with version 5.0.1"
    echo "  MARIE_VERSION=5.0.1 $0 marie-cuda    # Using environment variable"
}
