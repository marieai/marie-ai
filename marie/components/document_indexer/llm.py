    ...
    def predict(
        ...
        **kwargs,
        ...
        for task in tasks:
            ...
            parsed_output: List[PageResult] = parse_task_output(model_output, task.output_type)
            mod_output: List[PageResult] = modify_outputs(parsed_output, task.output_mod)
            for i, page_output in zip(filtered_pages_idx, mod_output):
                page_output.page = i
            task_outputs[task_name] = mod_output
        ...
        for task_name, model_output in task_outputs.items():
            ...
            for pred in model_output:
                documents[pred.page].tags[DOC_KEY_INDEXER][task_name] = pred
