...
class DocumentServerlessExecutor(MarieExecutor, StorageMixin):
    ...
    @requests(on="/evaluator")
    def evaluator(self, docs: DocList[AssetKeyDoc], parameters: dict, *args, **kwargs):
        """
        Document serverless executor
        ...
        self.logger.info("Starting serverless processing request")
