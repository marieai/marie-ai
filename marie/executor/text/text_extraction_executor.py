...
class TextExtractionExecutor(PipelineExecutor):
    ...
    def extract(self, docs: DocList[AssetKeyDoc], parameters: dict, *args, **kwargs):
        ...
        force_ocr = any(True for feature in features if feature.get("force", False))
        if force_ocr:
        ...
        # Use Default OCR handling of pipeline definition
        return self.execute_pipeline(
            docs, self.pipeline, job_id, ref_id, payload, ref_type, queue_id
        )
