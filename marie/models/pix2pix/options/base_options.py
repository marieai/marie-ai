...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            default='basic',
            help=(
                'specify discriminator architecture [basic | n_layers |'
                ' n_layers_spectral | pixel]. The basic model is a 70x70 PatchGAN.'
        ...
        parser.add_argument(
            ...
            default=float("inf"),
            help=(
                'Maximum number of samples allowed per dataset. If the dataset'
                ' directory contains more than max_dataset_size, only a subset is'
                ' loaded.'
            ),
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            default='0',
            help=(
                'which iteration to load? if load_iter > 0, the code will load models'
                ' by iter_[load_iter]; otherwise, the code will load models by [epoch]'
            ),
        )
        parser.add_argument(
            '--verbose',
