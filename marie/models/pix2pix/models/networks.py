...
from .loss import HingeLoss, LeakyHingeLoss
from .networks_hd import GlobalGenerator, LocalEnhancer, MultiscaleDiscriminator
...
class UnetGeneratorWithSpectralNorm(nn.Module):
    ...
    def __init__(
        ...
        # construct unet structure
        unet_block = UnetSkipConnectionBlockWithSpectralNorm(
            ngf * 8,
            ngf * 8,
            input_nc=None,
            submodule=None,
        ...
        self.model = UnetSkipConnectionBlockWithSpectralNorm(
            output_nc,
            ngf,
            input_nc=input_nc,
            submodule=unet_block,
