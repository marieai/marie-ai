from marie.core.tools.types import BaseTool, ToolOutput, adapt_to_async_tool
from typing import TYPE_CHECKING, Sequence
from marie.core.llms.llm import ToolSelection
import json
...
def call_tool_with_selection(
    ...
    from marie.core.tools.calling import call_tool
...
async def acall_tool_with_selection(
    ...
    from marie.core.tools.calling import acall_tool
