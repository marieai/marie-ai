...
if TYPE_CHECKING:
    from marie.core.bridge.langchain import StructuredTool, Tool

from marie.core.async_utils import asyncio_run
from marie.core.bridge.pydantic import BaseModel, FieldInfo
from marie.core.tools.types import AsyncBaseTool, ToolMetadata, ToolOutput
from marie.core.tools.utils import create_schema_from_function
from marie.core.workflow.context import Context
...
class FunctionTool(AsyncBaseTool):
    ...
    def to_langchain_tool(
        ...
        **langchain_tool_kwargs: Any,
        ...
        """To langchain tool."""
        from marie.core.bridge.langchain import Tool
    ...
    def to_langchain_structured_tool(
        ...
        **langchain_tool_kwargs: Any,
        ...
        from marie.core.bridge.langchain import StructuredTool
