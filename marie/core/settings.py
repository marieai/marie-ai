...
from marie.core.callbacks.base import BaseCallbackHandler, CallbackManager
...
from marie.core.node_parser import NodeParser, SentenceSplitter
from marie.core.schema import TransformComponent
from marie.core.types import PydanticProgramMode
...
class _Settings:
    ...
    def global_handler(self, eval_mode: str, **eval_params: Any) -> None:
        ...
        from marie.core import set_global_handler
