...
from marie.core.bridge.pydantic import Field, model_validator
from marie.core.llms.llm import LLM
from marie.core.memory.types import (
    DEFAULT_CHAT_STORE_KEY,
    BaseChatStoreMemory,
)
from marie.core.storage.chat_store import BaseChatStore, SimpleChatStore
from marie.core.utils import get_tokenizer
...
class ChatMemoryBuffer(BaseChatStoreMemory):
    ...
    def from_dict(cls, data: Dict[str, Any], **kwargs: Any) -> "ChatMemoryBuffer":
        from marie.core.storage.chat_store.loading import load_chat_store
