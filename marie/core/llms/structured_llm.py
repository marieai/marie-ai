...
from marie.core.llms.llm import (
    LLM,
    BaseLLMComponent,
    LLMChatComponent,
...
from marie.core.llms.callbacks import (
    llm_chat_callback,
    llm_completion_callback,
)
from marie.core.prompts.base import ChatPromptTemplate
...
class StructuredLLM(LLM):
    ...
    def stream_chat(
        ...
        for partial_output in stream_output:
            yield ChatResponse(
                message=ChatMessage(
                    role=MessageRole.ASSISTANT, content=partial_output.model_dump_json()
                ),
                raw=partial_output,
            )
