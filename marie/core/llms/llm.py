...
from marie.core.callbacks import CBEventType, EventPayload
from marie.core.base.llms.base import BaseLLM
from marie.core.base.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from marie.core.base.llms.generic_utils import (
    prompt_to_messages,
)
from marie.core.prompts import BasePromptTemplate, PromptTemplate
from marie.core.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from marie.core.instrumentation.events.llm import (
    LLMPredictEndEvent,
...
if TYPE_CHECKING:
    ...
    from marie.core.tools.types import BaseTool
    from marie.core.llms.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        Examples:
            ...
            ```
        """
        from marie.core.program.utils import get_program_for_llm
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """
        from marie.core.agent.react import ReActAgentWorker
        from marie.core.agent.types import Task
        from marie.core.chat_engine.types import AgentChatResponse
        from marie.core.memory import ChatMemoryBuffer
