...
from marie.core.instrumentation.event_handlers import BaseEventHandler
from marie.core.instrumentation.span import active_span_id
from marie.core.instrumentation.span_handlers import (
    BaseSpanHandler,
    NullSpanHandler,
)
from marie.core.instrumentation.events.base import BaseEvent
from marie.core.instrumentation.events.span import SpanDropEvent
import wrapt
    ...
    def span(self, func: Callable) -> Any:
        ...
        def wrapper(func: Callable, instance: Any, args: list, kwargs: dict) -> Any:
            ...
            def handle_future_result(
                ...
                from marie.core.workflow.errors import WorkflowCancelledByUser
