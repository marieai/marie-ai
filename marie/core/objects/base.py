...
from marie.core.objects.base_node_mapping import (
    DEFAULT_PERSIST_FNAME,
    BaseObjectNodeMapping,
    SimpleObjectNodeMapping,
)
from marie.core.schema import BaseNode, QueryBundle, QueryType
from marie.core.storage.storage_context import (
    DEFAULT_PERSIST_DIR,
    StorageContext,
)
...
class ObjectIndex(Generic[OT]):
    ...
    def from_objects(
        ...
        **index_kwargs: Any,
        ...
        from marie.core.objects.utils import get_object_mapping
    ...
    def from_persist_dir(
        ...
        from marie.core.indices import load_index_from_storage
