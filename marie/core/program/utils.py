...
from marie.core.llms.llm import LLM, ToolSelection
...
from marie.core.types import BasePydanticProgram, PydanticProgramMode
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            ...
            from marie.core.program.llm_program import (
