...
from marie.core.data_structs import IndexLPG
from marie.core.base.base_retriever import BaseRetriever
from marie.core.llms import LLM
from marie.core.embeddings.utils import EmbedType, resolve_embed_model
...
from marie.core.vector_stores.simple import DEFAULT_VECTOR_STORE
from marie.core.indices.base import BaseIndex
from marie.core.indices.property_graph.transformations import (
...
from marie.core.storage.docstore.types import RefDocInfo
from marie.core.storage.storage_context import StorageContext
from marie.core.schema import BaseNode, MetadataMode, TextNode, TransformComponent
from marie.core.settings import Settings
from marie.core.vector_stores.types import BasePydanticVectorStore

if TYPE_CHECKING:
    from marie.core.indices.property_graph.sub_retrievers.base import (
        BasePGRetriever,
    )
...
class PropertyGraphIndex(BaseIndex[IndexLPG]):
    ...
    def as_retriever(
        ...
        **kwargs: Any,
        ...
        """
        from marie.core.indices.property_graph.retriever import (
            PGRetriever,
        )
