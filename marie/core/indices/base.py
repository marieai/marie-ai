...
from marie.core.chat_engine.types import BaseChatEngine, ChatMode
from marie.core.data_structs.data_structs import IndexStruct
from marie.core.ingestion import run_transformations
from marie.core.llms.utils import LLMType, resolve_llm
from marie.core.schema import BaseNode, Document, IndexNode, TransformComponent
from marie.core.settings import Settings
from marie.core.storage.docstore.types import BaseDocumentStore, RefDocInfo
    ...
    def as_chat_engine(
        ...
        **kwargs: Any,
        ...
        if chat_mode in [ChatMode.REACT, ChatMode.OPENAI, ChatMode.BEST]:
            ...
            # NOTE: lazy import
            from marie.core.agent import AgentRunner
        ...
        if chat_mode == ChatMode.CONDENSE_QUESTION:
            # NOTE: lazy import
            from marie.core.chat_engine import CondenseQuestionChatEngine
            ...
            from marie.core.chat_engine import ContextChatEngine
            ...
            from marie.core.chat_engine import CondensePlusContextChatEngine
            ...
            from marie.core.chat_engine import SimpleChatEngine
