...
from marie.core.base.llms.types import ChatMessage, LLMMetadata
from marie.core.bridge.pydantic import Field, PrivateAttr
from marie.core.constants import DEFAULT_CONTEXT_WINDOW, DEFAULT_NUM_OUTPUTS
...
from marie.core.node_parser.text.utils import truncate_text
from marie.core.prompts import (
    BasePromptTemplate,
    ChatPromptTemplate,
    SelectorPromptTemplate,
)
from marie.core.prompts.prompt_utils import get_empty_prompt_txt
from marie.core.prompts.utils import format_string
...
class PromptHelper(BaseComponent):
    ...
    def _get_tools_from_llm(
        ...
        from marie.core.program.function_program import get_function_tool
