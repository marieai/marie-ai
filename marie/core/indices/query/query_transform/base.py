...
from marie.core.indices.query.query_transform.prompts import (
...
from marie.core.prompts.default_prompts import DEFAULT_HYDE_PROMPT
from marie.core.prompts.mixin import (
    PromptDictType,
    PromptMixin,
    PromptMixinType,
)
from marie.core.schema import QueryBundle, QueryType
