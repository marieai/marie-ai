...
# from marie.core.data_structs.data_structs import IndexGraph
from marie.core.data_structs.data_structs import IndexGraph
from marie.core.indices.base import BaseIndex
from marie.core.indices.common_tree.base import GPTTreeIndexBuilder
from marie.core.indices.tree.inserter import TreeIndexInserter
...
from marie.core.schema import BaseNode, IndexNode
...
class TreeIndex(BaseIndex[IndexGraph]):
    ...
    def as_retriever(
        ...
        **kwargs: Any,
        ...
        # NOTE: lazy import
        from marie.core.indices.tree.all_leaf_retriever import (
        ...
        from marie.core.indices.tree.tree_root_retriever import (
            TreeRootRetriever,
        )
