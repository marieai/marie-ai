...
from marie.core.bridge.pydantic_core import CoreSchema
from marie.core.instrumentation import DispatcherSpanMixin
from marie.core.utils import SAMPLE_TEXT, truncate_text
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from marie.core.bridge.langchain import Document as LCDocument  # type: ignore
...
class IndexNode(TextNode):
    ...
    def from_dict(cls, data: Dict[str, Any], **kwargs: Any) -> Self:  # type: ignore
        ...
        if isinstance(obj, str):
            ...
            from marie.core.storage.docstore.utils import json_to_doc
...
class Document(Node):
    ...
    def to_langchain_format(self) -> LCDocument:
        ...
        from marie.core.bridge.langchain import (
    ...
    def from_langchain_format(cls, doc: LCDocument) -> Document:
        ...
        if doc.task_id:
            return cls(text=doc.page_content, metadata=doc.metadata, id_=doc.task_id)
    ...
    def from_haystack_format(cls, doc: HaystackDocument) -> Document:
        ...
        return cls(
            text=doc.content, metadata=doc.meta, embedding=doc.embedding, id_=doc.task_id
        )
