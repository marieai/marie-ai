...
from marie.core.ingestion.cache import DEFAULT_CACHE_NAME, IngestionCache
from marie.core.instrumentation import get_dispatcher
from marie.core.node_parser import SentenceSplitter
...
from marie.core.storage.docstore import (
    BaseDocumentStore,
    SimpleDocumentStore,
)
from marie.core.storage.storage_context import DOCSTORE_FNAME
...
class IngestionPipeline(BaseModel):
    ...
    Examples:
        ```python
        from marie.core.ingestion import IngestionPipeline
        from marie.core.node_parser import SentenceSplitter
