...
from typing import Sequence, Union, Optional, NamedTuple, Mapping

from marie import check
from marie._annotations import public
from marie.core.definitions.dependency import NodeHandle
...
class MarieEventType(str, Enum):
    ...
    RUN_STARTING = "RUN_STARTING"  # Launch is happening, execution hasn't started yet
    RUN_START = "RUN_START"  # Execution has started
...
EVENT_TYPE_TO_PIPELINE_RUN_STATUS = {
    MarieEventType.RUN_START: MarieRunStatus.STARTED,
    MarieEventType.RUN_SUCCESS: MarieRunStatus.SUCCESS,
    MarieEventType.RUN_FAILURE: MarieRunStatus.FAILURE,
    MarieEventType.RUN_ENQUEUED: MarieRunStatus.QUEUED,
    MarieEventType.RUN_STARTING: MarieRunStatus.STARTING,
    MarieEventType.RUN_CANCELING: MarieRunStatus.CANCELING,
    MarieEventType.RUN_CANCELED: MarieRunStatus.CANCELED,
}
