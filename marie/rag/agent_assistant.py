...
from marie.rag.agent_document_search import DocumentSearchTool

if TYPE_CHECKING:
    from marie.agent.llm_wrapper import BaseLLMWrapper
    from marie.rag.retriever import RAGRetriever

logger = logging.getLogger("marie.rag.agent_assistant")
...
class DocumentAssistant(ReactAgent):
    ...
    Example:
        ...
        from marie.rag.agent_assistant import DocumentAssistant
