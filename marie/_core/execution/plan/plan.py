...
from .handle import StepHandle, ResolvedFromDynamicStepHandle, UnresolvedStepHandle
from .step import (
    IExecutionStep,
    ExecutionStep,
...
class ExecutionPlan(
    ...
    def __new__(
        ...
        resolvable_map: Dict[
            FrozenSet[str], Sequence[Union[StepHandle, UnresolvedStepHandle]]
        ],
        step_handles_to_execute: Sequence[StepHandleUnion],
        known_state: KnownExecutionState,
        ...
        return super(ExecutionPlan, cls).__new__(
            ...
            known_state=check.inst_param(
                known_state, "known_state", KnownExecutionState
            ),
            artifacts_persisted=check.bool_param(
