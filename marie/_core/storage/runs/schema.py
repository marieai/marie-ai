...
db.Index(
    "idx_run_partitions",
    RunsTable.c.partition_set,
    RunsTable.c.partition,
    mysql_length=64,
)
db.Index(
    "idx_runs_by_job",
...
db.Index(
    "idx_bulk_actions_action_type", BulkActionsTable.c.action_type, mysql_length=32
)
db.Index(
    "idx_bulk_actions_selector_id", BulkActionsTable.c.selector_id, mysql_length=64
)
