...
class BaseWorkspaceRequestContext(IWorkspace):
    ...
    def get_external_notebook_data(
        self, code_location_name: str, notebook_path: str
    ) -> bytes:
...
class WorkspaceProcessContext(IWorkspaceProcessContext):
    ...
    def __init__(
        ...
        self.add_state_subscriber(
            LocationStateSubscriber(self._location_state_events_handler)
        )
        ...
        self._update_workspace(
            {
                origin.location_name: self._load_location(origin)
