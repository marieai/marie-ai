...
from marie._annotations import PublicAttr
from marie._core.definitions.events import AssetKey, AssetMaterialization
from marie._core.errors import DagsterInvalidInvocationError
...
class EventRecordsFilter(
    ...
    def __new__(
        ...
        return super(EventRecordsFilter, cls).__new__(
            ...
            before_timestamp=check.opt_float_param(
                before_timestamp, "before_timestamp"
            ),
            storage_ids=check.opt_sequence_param(
