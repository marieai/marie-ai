...
from marie.serve.runtimes.gateway.http.middleware import WhitelistMiddleware
...
def get_fastapi_app(
    ...
    :param ip_whitelist: if set the Whitelist Middleware will be applied
