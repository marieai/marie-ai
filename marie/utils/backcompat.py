...
EXPERIMENTAL_WARNING_HELP = (
    ...
    ' warnings.filterwarnings("ignore", category=marie.ExperimentalWarning) or use'
...
def experimental_class_param_warning(
    param_name: str, class_name: str, stacklevel=3
) -> None:
