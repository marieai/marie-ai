# marie.document.TrOcrProcessor

### *class* marie.document.TrOcrProcessor(work_dir: str = '/tmp/icr', model_name_or_path: str | PathLike = None, cuda: bool = True, \*\*kwargs)

#### \_\_init_\_(work_dir: str = '/tmp/icr', model_name_or_path: str | PathLike = None, cuda: bool = True, \*\*kwargs) → None

### Methods

| [`__init__`](#marie.document.TrOcrProcessor.__init__)([work_dir, model_name_or_path, cuda])   |                                                                                                                                |
|-----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
