...
#### \_\_init_\_(work_dir: str = '/tmp/boxes', models_dir: str = '/mnt/marie/model_zoo', cuda: bool = False, refinement: bool = True)
...
| `psm_sparse_step`(image, adj_x, adj_y)                                                       | Perform a step in the PSM sparse pipeline.                                                                                     |
